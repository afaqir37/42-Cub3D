...
int					ft_parse_args(int ac, char **av, t_info **inf,
						t_file **fle);
...
int					ft_to_find_index(char *string, char *lookingfor, int i,
						int j);
...
void				_horz_vert_choice(t_data *data, t_horz *horz, t_vert *vert,
						int i);
